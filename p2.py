...
p = Process(pid=2, all_ports=all_ports, num_processes=len(all_ports), request_ts_l=[[68], [2], [200]])
...
p.send_request(target_pid_list=[0, 1], job_config=[200, 'CheckBalance',  'C', None])
